...
function mergedSettings(): Settings {
  ...
  return {
    ...
    NOTION_PAGES_PARENT_ID:
      process.env.NOTION_PAGES_PARENT_ID ?? file.NOTION_PAGES_PARENT_ID,
    NOTION_METADATA_DATABASE_ID:
      process.env.NOTION_METADATA_DATABASE_ID ?? file.NOTION_METADATA_DATABASE_ID,
