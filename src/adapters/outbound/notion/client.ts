...
import type { LogsColumns, TodosColumns, TodosDoneKind } from '@app/shared/notion-scope';

export { getColumnPurpose };
export type { AllowedNotionScope, LogsColumns, TodosColumns, TodosDoneKind } from '@app/shared/notion-scope';
