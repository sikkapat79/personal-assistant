...
/** Ask for the "brain" (OpenAI agent) first, then Notion data sources, then optional parent page. */
export const SETUP_STEPS: { key: keyof Settings; label: string }[] = [
  ...
  { key: 'NOTION_PAGES_PARENT_ID', label: 'Notion parent page ID (optional; for future create-page scope. Esc: skip)' },
];
